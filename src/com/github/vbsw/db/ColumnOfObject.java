...
public class ColumnOfObject {
	...
	public ColumnOfObject ( ) {
		this(INITIAL_CAPACITY);
	}

	public ColumnOfObject ( final int initialCapacity ) {
	...
	public void add ( final Object value ) {
		...
		if ( length == values.length ) {
			final Object[] valuesNew = new Object[values.length * 2];
	...
	@Override
	public ColumnOfObject clone ( ) {
		final ColumnOfObject newColumn = new ColumnOfObject(values.length);
