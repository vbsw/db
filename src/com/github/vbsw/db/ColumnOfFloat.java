...
public class ColumnOfFloat {
	...
	public ColumnOfFloat ( ) {
		this(INITIAL_CAPACITY);
	}

	public ColumnOfFloat ( final int initialCapacity ) {
	...
	public void add ( final float value ) {
		...
		if ( length == values.length ) {
			final float[] valuesNew = new float[values.length * 2];
	...
	@Override
	public ColumnOfFloat clone ( ) {
		final ColumnOfFloat newColumn = new ColumnOfFloat(values.length);
